...
export function generateMockReport(req: AnalyzePropertyRequest): PropertyReport {
  ...
  return {
    ...
    investment: {
      ...
      finalSummary:      `${req.suburb} presents a solid medium-term investment case with a good balance of yield and growth potential. The vacancy rate of ${suburb.vacancyRate} confirms strong rental demand, and the suburb profile supports sustained owner-occupier price floors. Pricing appears reasonable relative to suburb fundamentals. For a ${req.purpose === 'investment' ? 'rental investor' : 'owner-occupier'}, this is a Good Buy subject to a satisfactory building inspection.`,
      keyMetrics: {
